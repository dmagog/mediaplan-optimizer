...
доля миров, где и расход, и результат уложились в порог кейса, растёт с 45 до
60 %.
...
Что осталось за границей прототипа: перераспределение между неделями (бюджет
дня пропорционален спросу дня, но недели между собой не выравниваются),
региональные цены, аукцион второй цены и обучение на логах ставок. Все упрощения перечислены в
