...
Медиапланирование и почасовое ведение кампании. Сервис собирает медиаплан по
восьми каналам, прогоняет кампанию час за часом и перекладывает бюджет между
каналами, когда рынок расходится с планом. Всё, что нельзя решить автоматикой,
он приносит человеку карточкой с разбором: почему, что будет, если сделать, и
