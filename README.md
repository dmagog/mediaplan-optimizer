...
Ноль выключает правило. Сейчас это правило кабинета поверх готового прогона:
...
После расчёта план можно поправить руками: на экране плана в кабинете
менеджера у каждого канала бегунок. Двигаете — канал фиксируется на этой
сумме (`locked` в брифе планировщика), остальной бюджет планировщик
раскладывает заново по тем же правилам, прогноз пересчитывается. Если канал
упирается в свою ёмкость, кабинет говорит, сколько он реально взял и почему.
Кнопка «Вернуть расчёт» снимает все фиксации.
