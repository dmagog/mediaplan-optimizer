...
канале — это цена бездействия. Правила кампании живут в отдельном окне: на
брифе — строка-сводка с кнопкой, в шапке — шестерёнка, доступная с любого
экрана. В окне два порога:
